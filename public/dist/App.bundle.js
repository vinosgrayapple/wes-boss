...
async function autocomplete(input, latInput, lngInput) {
    if (!input) return;
    var dropdown = await new google.maps.places.Autocomplete(input);
...
function loadPlaces(map) {
    var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 48.597376;
    var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 38.004726;

    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (resp) {
...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
            ...
            searchResults.innerHTML = _dompurify2.default.sanitize('\n                    <span class="search__result">No Result for <strong>' + _this.value + '</strong> Found</span>\n                    ');
        }).catch(function (err) {
